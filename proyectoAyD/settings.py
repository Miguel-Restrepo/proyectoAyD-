"""
Django settings for proyectoAyD project.
...
SECRET_KEY = 'django-insecure-g$cp$^(hc2k13seqnwo7upzy2xaeo*!43p0y&*0uqvp%814!f0'
...
WSGI_APPLICATION = 'proyectoAyD.wsgi.application'
